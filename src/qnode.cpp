...
*****************************************************************************/
  ...
  //Construct RobotState class from RobotModel
    ...
    // Add your ros communications here.
        ...
        interactive_publisher = n.advertise<visualization_msgs::InteractiveMarker>( "interactive_marker", 1 );
        interactive_markers::InteractiveMarkerServer server("motorosudp");
  // create an interactive marker for our server
        while (joint_publisher.getNumSubscribers()<1) {
            //std::cout<<"Waiting..."<<std::endl;//Wait
            ;
        }
...
//  moveit::planning_interface::MoveGroupInterface move_group(PLANNING_GROUP);
        motomini_model_group_ptr = motomini_model_ptr->getJointModelGroup(PLANNING_GROUP);
        motomini_state_ptr->setJointGroupPositions (motomini_model_group_ptr, joints);
